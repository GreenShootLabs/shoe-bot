...
class SetWebchatSettings extends Command
{
    ...
    public function handle()
    {
        ...
        $settings = [
            ...
            WebchatSetting::LAUNCHER_BACKGROUND => '#1b212a',
            WebchatSetting::RECEIVED_MESSAGE_TEXT => '#1b212a',
            ...
            WebchatSetting::EXTERNAL_BUTTON_BACKGROUND => '#0000ff',
            WebchatSetting::EXTERNAL_BUTTON_HOVER_BACKGROUND => '#0000ff',
            WebchatSetting::EXTERNAL_BUTTON_TEXT => '#ffffff',
            ...
            WebchatSetting::NEW_USER_START_MINIMIZED => true,
